...
For example:
- Padauk 5.001, or Padauk 5.100 will return either 'RenderingGraphite' or 'RenderingOpenType, indicating how it has rendered as viewed.
...
- Awami Nastliq 3.300 will return either 'RenderingGraphite' or 'RenderingUnknown.
    ...
    - *If it is known for certain that Awami Nastliq 3.300 or 3.4000 are available (e.g., a webfont), then this can be used as a test to identify whether or not rendering is being handled by Graphite in cases other than Firefox, or could be used to identify if Graphite is disabled in Firefox config.*
...
function Component(){
  ...
  const webfonts = [
    ...
    { source: 'Web', name: 'Padauk 6-000', id: 'padauk-6-000' },
